...
package com.exfantasy.test.example13;
...
//      job = newJob(SimpleRecoveryJob.class).withIdentity("job_" + count, schedId) // put triggers in group
...
//          .build();
//
//      trigger = newTrigger().withIdentity("triger_" + count, schedId)
